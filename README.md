...
Instructions to help you build the project and develop are available in the [SETUP.md](./blob/master/SETUP.md) file.
...
Please take a look at our [contributing](./blob/master/CONTRIBUTING.md) guidelines before submitting your pull request.
