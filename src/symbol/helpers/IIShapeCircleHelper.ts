...
import { PartialDeep, findIntersectBetweenSegmentAndCircle, computeRotatedPoint, computeDistance, TWO_PI } from "@/utils"
...
export const IIShapeCircleHelper = {
  create(center: TPoint, radius: number, style?: PartialDeep<TStyle>): TShapeCircle
  {
  ...
  createFromPartial(partial: PartialDeep<TShapeCircle>): TShapeCircle
  {
  ...
  createBetweenPoints(origin: TPoint, target: TPoint, style?: PartialDeep<TStyle>): TShapeCircle
  {
