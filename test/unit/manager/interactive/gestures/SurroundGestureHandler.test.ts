...
describe("SurroundGestureHandler.ts", () =>
{
  ...
  describe("apply", () =>
  {
    test("should handle Select action", async () =>
    {
      ...
      IIStrokeHelper.addPointer(gestureStroke, { x: 25, y: 25, p: 1, t: 400 })
    ...
    test("should handle Highlight action", async () =>
    {
      ...
      IIStrokeHelper.addPointer(gestureStroke, { x: 35, y: 30, p: 1, t: 200 })
    ...
    {
      const gestureStroke = buildIIStroke()
      IIStrokeHelper.addPointer(gestureStroke, { x: 100, y: 100, p: 1, t: 100 })
      IIStrokeHelper.addPointer(gestureStroke, { x: 200, y: 200, p: 1, t: 200 })
  ...
  describe("integration", () =>
  {
    test("should select symbols within gesture bounds", async () =>
    {
      ...
      IIStrokeHelper.addPointer(stroke1, { x: 15, y: 15, p: 1, t: 200 })

      const stroke2 = buildIIStroke()
      IIStrokeHelper.addPointer(stroke2, { x: 100, y: 100, p: 1, t: 300 })
      IIStrokeHelper.addPointer(stroke2, { x: 105, y: 105, p: 1, t: 400 })

      editor.model.addSymbol(stroke1)
      editor.model.addSymbol(stroke2)

      const gestureStroke = buildIIStroke()
      IIStrokeHelper.addPointer(gestureStroke, { x: 5, y: 5, p: 1, t: 500 })
      IIStrokeHelper.addPointer(gestureStroke, { x: 20, y: 20, p: 1, t: 600 })
