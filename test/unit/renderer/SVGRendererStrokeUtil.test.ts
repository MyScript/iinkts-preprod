import { SVGRendererStrokeUtil, IIStrokeHelper } from "../../../src/iink"
...
describe("SVGRendererStrokeUtil.ts", () =>
{
  ...
  test("should getSVGPath when 2 pointers with default width (2)", () =>
  {
    ...
    IIStrokeHelper.addPointer(stroke, { p: 1, t: 1, x: 10, y: 1 })
  ...
  {
    const stroke = IIStrokeHelper.create({ width: 4 })
    IIStrokeHelper.addPointer(stroke, { p: 1, t: 1, x: 1, y: 1 })
    IIStrokeHelper.addPointer(stroke, { p: 1, t: 1, x: 10, y: 1 })
  ...
  test("should getSVGPath when more than 2 pointers", () =>
  {
    ...
    IIStrokeHelper.addPointer(stroke, { p: 1, t: 1, x: 7, y: 5 })
    IIStrokeHelper.addPointer(stroke, { p: 1, t: 1, x: 10, y: 1 })
