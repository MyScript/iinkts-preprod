import { SVGRendererStrokeUtil, StrokeHelper } from "../../../src/iink"
...
describe("SVGRendererStrokeUtil.ts", () =>
{
  ...
  test("should getSVGPath when 2 pointers with default width (2)", () =>
  {
    ...
    StrokeHelper.addPointer(stroke, { p: 1, t: 1, x: 10, y: 1 })
  ...
  {
    const stroke = StrokeHelper.create({ width: 4 })
    StrokeHelper.addPointer(stroke, { p: 1, t: 1, x: 1, y: 1 })
    StrokeHelper.addPointer(stroke, { p: 1, t: 1, x: 10, y: 1 })
  ...
  test("should getSVGPath when more than 2 pointers", () =>
  {
    ...
    StrokeHelper.addPointer(stroke, { p: 1, t: 1, x: 7, y: 5 })
    StrokeHelper.addPointer(stroke, { p: 1, t: 1, x: 10, y: 1 })
