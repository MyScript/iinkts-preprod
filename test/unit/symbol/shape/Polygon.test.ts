import { ShapePolygonHelper } from "../../../../src/symbol/shape/Polygon"
import
{
  TPoint,
  TStyle,
...
describe("Polygon.ts", () =>
{
  describe("overlaps", () =>
  {
    ...
    test(`should return true if partially wrap`, () =>
    {
      ...
      expect(ShapePolygonHelper.overlaps(polygon, boundaries)).toEqual(true)
    })
    ...
    test(`should return false if box is outside`, () =>
    {
      ...
      expect(ShapePolygonHelper.overlaps(polygon, boundaries)).toEqual(false)
    })
