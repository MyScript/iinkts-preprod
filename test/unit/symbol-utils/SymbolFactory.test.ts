...
describe("createSymbolFromPartial", () =>
{
  ...
  {
    const partial: any = { type: SymbolType.Text, id: "text-1", chars: [{ label: "A", fontSize: 12, fontWeight: "normal" }], point: { x: 0, y: 0 }, bounds: { x: 0, y: 0, width: 10, height: 10 } }
    const symbol = createSymbolFromPartial(partial)
  ...
  {
    const partial: any = { type: SymbolType.Math, id: "math-1", elements: [{ id: "e1", label: "1", fontSize: 12, fontWeight: "normal", fontFamily: "Arial", color: "#000", bounds: { x: 0, y: 0, width: 10, height: 10 } }], point: { x: 0, y: 0 }, bounds: { x: 0, y: 0, width: 10, height: 10 } }
    const symbol = createSymbolFromPartial(partial)
  ...
  {
    const partial: any = { type: SymbolType.Shape, kind: ShapeKind.Circle, id: "circle-1", center: { x: 50, y: 50 }, radius: 25 }
    const symbol = createSymbolFromPartial(partial)
  ...
  {
    const partial: any = { type: SymbolType.Edge, kind: EdgeKind.Line, id: "line-1", start: { x: 0, y: 0 }, end: { x: 10, y: 10 } }
    const symbol = createSymbolFromPartial(partial)
...
describe("createShapeFromPartial", () =>
{
  ...
  {
    const partial: any = { kind: ShapeKind.Polygon, points: [{ x: 0, y: 0 }, { x: 10, y: 0 }, { x: 10, y: 10 }] }
...
describe("createEdgeFromPartial", () =>
{
  it("should build arc", () =>
  {
    const partial: any = { kind: EdgeKind.Arc, center: { x: 50, y: 50 }, radiusX: 30, radiusY: 20, startAngle: 0, sweepAngle: Math.PI, phi: 0 }
  ...
  {
    const partial: any = { kind: EdgeKind.PolyEdge, points: [{ x: 0, y: 0 }, { x: 10, y: 10 }, { x: 20, y: 0 }] }
