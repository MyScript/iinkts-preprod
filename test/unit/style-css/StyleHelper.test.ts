import { StyleHelper, DefaultPenStyle, DefaultTheme, TPenStyle, TTheme } from "@/iink"
...
describe("StyleHelper.ts", () => {
  ...
  test("should themeToCSS for CustomTheme", () => {
    ...
    const themeStringExpected =
      "ink {color: #2E7D32;-myscript-pen-width: 2;-myscript-pen-fill-style: purple;-myscript-pen-fill-color: #FFFFFF00;}.math {font-family: STIXGeneral;}.math-solved {font-family: STIXGeneral;color: blue;}.text {font-family: Rubik Distressed;font-size: 10;}"
  ...
  test("should themeToJSON for v", () => {
    ...
    const themeString =
      "ink {width: 42;color: #2E7D32;-myscript-pen-width: 2;-myscript-pen-fill-style: purple;-myscript-pen-fill-color: #FFFFFF00;}.math {font-family: STIXGeneral;}.math-solved {font-family: STIXGeneral;color: blue;}.text {font-family: Rubik Distressed;font-size: 10;}"
