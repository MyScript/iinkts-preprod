...
declare function isChangesEmpty(changes: TOIHistoryChanges): boolean;
/**
 * @group History
 */
...
declare class OIRecognizer {
    ...
    protected buildAddStrokes(strokes: OIStroke[], processGestures?: boolean): TOIMessageEvent;
