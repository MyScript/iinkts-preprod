 ...
 * @group Primitive
 */
declare class OIStrokeText extends OISymbolBase<SymbolType.StrokeText> {
    readonly isClosed = false;
    strokes: OIStroke[];
    decorators: OIDecorator[];
    baseline: number;
 ...
 * @group Primitive
 */
type TOISymbol = TOIEdge | TOIShape | OIStroke | OISymbolGroup | OIText | OIStrokeText;
 ...
 * @group Renderer
 */
declare class OISVGRendererStrokeTextUtil {
