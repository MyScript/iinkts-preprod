...
declare class OIPointerEventGrabber implements IGrabber {
    ...
    protected getPointerInfos(evt: PointerEvent): {
        clientX: number;
        clientY: number;
        isPrimary: boolean;
        type: string;
    ...
    attach(layerCapture: SVGElement): void;
    detach(): void;
}
...
declare class OIRecognizer {
    ...
    newSession(serverConfiguration?: TServerConfiguration, recognitionConfiguration?: TRecognitionConfiguration): Promise<void>;
    init(): Promise<void>;
...
declare class OIConversionManager {
    ...
    constructor(behaviors: OIBehaviors, fontStyle?: {
        ...
        weight?: ("bold" | "normal" | "auto") | undefined;
    });
    get model(): OIModel;
...
declare class OIBehaviors implements IBehaviors {
    ...
    protected onContentChanged(undoRedoContext: TUndoRedoContext): Promise<void>;
    init(): Promise<void>;
    ...
    convertSymbols(symbols?: TOISymbol[]): Promise<OIModel>;
    waitForIdle(): Promise<void>;
...
declare class Editor {
    ...
    layers: EditorLayer;
    event: EditorEvent;
    constructor(rootElement: HTMLElement, options: PartialDeep<TBehaviorOptions>, globalClassCss?: string);
